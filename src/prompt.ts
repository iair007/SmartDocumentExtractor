const extractDataPrompt = (isPdf: boolean, explanation: string) => `
Please analyze the following invoice image and extract the data in JSON format.

${
  isPdf
    ? "Extract the text from the PDF with file ID ${explanation}."
    : "Invoice Image: data:image/jpeg;base64,${explanation}"
}
